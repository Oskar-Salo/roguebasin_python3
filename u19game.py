"""
author: Oskar Salomonowitz
email: oskarsalomonowitz@icloud.com
license: gpl, see http://www.gnu.org/licenses/gpl-3.0.de.html
download: https://github.com/Oskar-Salo/roguebasin_python3/tree/master
...
class Viewer():
    ...
    def draw_panel(self):
        ...
        for dy, thing in enumerate(here):
            ...
            if thing.is_member("Monster"):
                t = Game.legend[thing.char] + "  hp:" + str(thing.hitpoints)
            else:
                    ...
                    if event.key == pygame.K_SPACE:
                        ...
                        for o in Game.objects.values():
                            if (o.z == self.game.player.z and
                                ...
                                self.game.player.hitpoints < self.game.player.hitpoints_max and
                                o.__class__.__name__=="Shop"):
                                self.game.player.gold -= 1
                                self.game.player.hitpoints += 10
                                self.game.player.hitpoints = minmax(self.game.player.hitpoints, 0, self.game.player.hitpoints_max)
